...
{
    resize(850, 550);
    setWindowTitle(tr("Jade") + " - " + tr("Wallet") + " " + QString::fromStdString(CLIENT_BUILD));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Jade address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Jade"), this);
    aboutAction->setToolTip(tr("Show information about Jade"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Jade"));
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/Jade_testnet"));
            setWindowIcon(QIcon(":icons/Jade_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Jade_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Jade client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Jade client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Jade network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Jade address or malformed URI parameters."));
    }
