...
const string strMessageMagic = "Jade Signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    else
    {
        ...
        // Jade: reward for coin-year is cut in half every 64x multiply of PoS difficulty
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Jade
    bool fStrictPayToScriptHash = true; // Always active in Jade
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Jade", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Thursday, December 24, 05:38 AM: Post-debate, voters move to Clinton";
        CTransaction txNew;
        ...
        txNew.strTxComment = "text:Jade genesis block";
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "version")
    {
        ...
        // Jade: disconnect any known version prior 2.0.3
        // as these have PoS not working and could serve us garbage
        printf("connected subver %s\n", pfrom->strSubVer.c_str());
        if (!strcmp(pfrom->strSubVer.c_str(),"/Jade:2.0.1/")
            || !strcmp(pfrom->strSubVer.c_str(),"/Jade:2.0.2.1/")
            || !strcmp(pfrom->strSubVer.c_str(),"/Jade:0.7.2/")
