...
Alternatively, install Qt Creator and open the `jade.pro` file.

An executable named `jade-qt` will be built.
...
installed causes Jade-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
